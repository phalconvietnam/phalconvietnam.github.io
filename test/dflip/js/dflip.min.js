...
(function e(t, i) {
    ...
    var n = (t.defaults = {
        ...
        textureLoadFallback: "/test/dflip/images/textures/white.jpg",
        stiffness: 3,
        backgroundImage: "",
        pageRatio: null,
    ...
    function q() {
        G = (function (e) {
            ...
            function t(t) {
                ...
                a.spotLight.shadow.bias = -0.009;
                a.spotLight.shadow.opacity = 1;
                a.spotLight.shadow.mapSize.width = 512; // Tăng độ phân giải chiều rộng
                a.spotLight.shadow.mapSize.height = 512; // Tăng độ phân giải chiều cao
                ...
                try {
                    if (this.options && this.options.soundEnable == true) {
                        const playAudio = () => {
                            ...
                            // Xóa sự kiện sau khi âm thanh được phát
                            document.removeEventListener("click", playAudio);
                            document.removeEventListener("touchstart", playAudio);
                        };

                        // Kiểm tra nếu người dùng chưa tương tác, thêm sự kiện lắng nghe
                        if (document.readyState === "interactive" || document.readyState === "complete") {
                            document.addEventListener("click", playAudio, { once: true });
                            document.addEventListener("touchstart", playAudio, { once: true });
                        } else {
                            // Nếu tài liệu chưa sẵn sàng, đợi đến khi sẵn sàng
